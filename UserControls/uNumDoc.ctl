...
Public Property Let TIPODOC(cual As eTipoDoc)
    ...
    Select Case mTipoDoc
     Case TipoDocFactura: mVeri = "ABC": txtLet.Locked = False
...
Public Property Let suc(cual As Long)
    If cual < 1 Or cual > 99998 Then
        txtSuc = ""
    Else
        txtSuc = Format(cual, CuantosDigitosPV()) '"0000")
    End If
End Property
...
Private Sub txtLet_GotFocus()
    On Error Resume Next
    txtLet.SelStart = 0
    txtLet.SelLength = Len(txtLet)
End Sub
