...
Begin VB.Form frmCuentasP 
   Caption         =   "Cuentas de proveedores"
   ClientHeight    =   11775
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11085
   Icon            =   "frmCuentasP.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   11775
   ScaleWidth      =   11085
...
ucXls1.ini gCuentas, "C:\CuentasProveedores.xls"
cVer
End Sub
...
sVeo = "Select CODIGO AS PROVEEDOR, DESCRIPCION,CUENTASCOMPRAS AS [CUENTAS CONTABLES],'' AS DETALLE FROM PROV WHERE ACTIVO=1"
