VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptChequesDebitados 
   Bindings        =   "rptChequesDebitados.dsx":0000
   Caption         =   "Listado de Cheques Debitados"
   ClientHeight    =   6270
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12135
   ...
   TopMargin       =   200
   BottomMargin    =   1440
   DataMember      =   "LisChequesDebitados"
   NumSections     =   5
   SectionCode0    =   1
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "LISTADO DE CHEQUES DEBITADOS"
         Alignment       =   2
      EndProperty
      ItemType2       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptChequesDebitados"
