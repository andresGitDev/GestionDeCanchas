VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptChequesTransferidos 
   Bindings        =   "rptChequesTransferidos.dsx":0000
   Caption         =   "Listado de Cheques Transferidos"
   ClientHeight    =   6375
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   11400
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "LISTADO DE CHEQUES DE TERCEROS TRANSFERIDOS"
         Alignment       =   2
      EndProperty
      ItemType2       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptChequesTransferidos"
