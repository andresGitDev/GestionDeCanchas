VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptProductosElijoDescripcion 
   Bindings        =   "rptProductosElijoDescripcion.dsx":0000
   ...
   TopMargin       =   200
   BottomMargin    =   1440
   DataMember      =   "dbo_LisProductosXcodigo"
   NumSections     =   5
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "rptProductosElijoDescripcion"
